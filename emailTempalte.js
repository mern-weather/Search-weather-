            	...
            	<tr>
            		<td>
            			<div class="text" style="text-align: center;">
            				<h2>Discover your city and see what's around the corner</h2>
            			</div>
            		</td>
            	</tr>
            </table>
	      ...
	      <tr>
	        <td class="bg_dark email-section" style="text-align:center;">
	        	<div class="heading-section heading-section-white">
	          	<h2>Welcome To Weatcher app</h2>
	          	<p>Five reasons why you’ll love planning your day with Hello Weather App</p>
	        	</div>
	        </td>
	      </tr><!-- end: tr -->
	      <tr>
					            ...
					            <td class="bg_white email-section">
			                      ...
			                      <td valign="top" width="50%">
			                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
		                              ...
		                              <a href="#"><img src=${
                                    images[1]
                                  } alt="" style="width: 100%; max-width: 600px; height: auto; margin: auto; display: block;"></a>
        	...
        	<td valign="middle" class="bg_black footer email-section">
                ...
                <td valign="top" width="33.333%">
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	<p>&copy; 2018 Travel. All Rights Reserved</p>
                      </td>
                    </tr>
                  </table>
                </td>
